...
* Security Fix: Missing Authorization / Sensitive Information Exposure via the custom fields AJAX action. Thanks to the security researcher "Shikhali Jamalzade" from [WPScan](https://wpscan.com/).
* Fix: PHP warning ("Undefined array key 0") on the listing edit form when editing a listing that has no category assigned.
* Tweak: Updated Freemius SDK to version 2.13.4.

= 3.4.2 =

* New: Added support for the Rank Math SEO plugin.
* Tweak: Updated Freemius SDK to version 2.13.2.
* Fix: Selected category/location names containing special characters (e.g. &) were not displayed correctly in the terms dropdown.
...
* New: Enhanced the "Anti-Spam" feature with support for configuring an email blacklist for the contact form.
* Tweak: Updated the Freemius SDK to version 2.12.0.
* Fix: Resolved issues with random listing order not working correctly across paginated results.
* Fix: WordPress 6.8 compatibility issues.
* Fix: Addressed various minor bugs to improve stability and ensure a smoother user experience.
